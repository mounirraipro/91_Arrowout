...
export const metadata: Metadata = {
    ...
    description: 'Arrow Out is a safe, educational, and family-friendly game. Learn how we protect children and promote healthy screen time.',
    keywords: ['Arrow Out for kids', 'safe game', 'children online safety', 'educational game', 'family friendly games'],
};
        ...
        <>
            <div className="page-header">
                <div className="container">
                    ...
                    <p>Everything parents need to know about Arrow Out and online safety.</p>
                </div>
            </div>
            ...
            <div className="page-content">
                ...
                <p>
                    Arrow Out is a family-friendly game created to provide wholesome entertainment
                    for players of all ages. We understand that parents care deeply about what their children
                    do online, and we&apos;ve built Arrow Out with safety, education, and fun as our core priorities.
                </p>
                ...
                <p>
                    ...
                    children and adults alike. Here&apos;s what your child gains from playing Arrow Out:
                </p>
                <ul>
                ...
                <p>
                    Arrow Out does not collect any personal information from children. There are no
                ...
                <p>
                    Arrow Out is completely free to play with no hidden costs. There are no virtual
                ...
                <p>
                    All content used in Arrow Out is carefully curated to be appropriate for all ages.
                    All content in Arrow Out is carefully selected to be appropriate for all ages.
                </p>

                <h3>Advertisements</h3>
                <p>
                    Arrow Out displays advertisements to support the free service. These ads are served
                ...
                <p>
                    We take the Children&apos;s Online Privacy Protection Act (COPPA) seriously. Arrow Out
                ...
                <p>
                    While Arrow Out is designed to be safe, we encourage parents to take an active role
                ...
                <ol>
                    ...
                    <li><strong>Discuss online safety:</strong> Use Arrow Out as a starting point to talk about safe internet habits.</li>
                ...
                <h2>Have Concerns?</h2>
                <p>
                    If you have any questions or concerns about your child&apos;s experience on Arrow Out,
