...
const SUPPORT_EMAIL = 'hello@arrowout.org';

export const metadata: Metadata = {
    title: 'Contact Arrow Out',
    description: 'Get in touch with the Arrow Out team for support, feedback, partnerships, accessibility concerns, or privacy questions.',
    keywords: ['contact Arrow Out', 'Arrow Out support', 'game contact'],
    alternates: {
        canonical: '/contact',
    },
};
