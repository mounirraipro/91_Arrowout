...
export const metadata: Metadata = {
    ...
    description: 'Arrow Out is committed to digital accessibility. Learn about our efforts to make our game available to everyone.',
    keywords: ['Arrow Out accessibility', 'accessible game', 'web accessibility statement'],
};
        ...
        <>
            <div className="page-header">
                <div className="container">
                    ...
                    <p>Our commitment to making Arrow Out accessible to everyone.</p>
                </div>
            </div>

            <div className="page-content">
                <p>
                    Arrow Out is committed to ensuring digital accessibility for people with disabilities.
                ...
                <p>
                    We recognize that the game component of Arrow Out presents additional accessibility
                ...
                <h2>Feedback</h2>
                <p>
                    We welcome your feedback on the accessibility of Arrow Out. If you encounter
                ...
                <ul>
                    ...
                    <li>Email: <strong>accessibility@arrowout.org</strong></li>
                </ul>
                <p>
