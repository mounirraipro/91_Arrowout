...
export const metadata: Metadata = {
    title: 'Cookie Policy',
    description: 'Learn about the cookies Arrow Out uses, why we use them, and how to manage your cookie preferences.',
    keywords: ['Arrow Out cookies', 'cookie policy', 'cookie preferences', 'tracking cookies'],
};
    ...
    return (
        <>
            ...
            <div className="page-content">
                <p>
                    This Cookie Policy explains what cookies are, how Arrow Out uses them, and how you can
                ...
                <p>Arrow Out uses cookies for the following purposes:</p>
                ...
                <p>
                    We currently do not use any tracking or analytics cookies (such as Google Analytics) on Arrow Out.
                </p>
                ...
                <p>
                    ...
                    or email <strong>privacy@arrowout.org</strong>.
                </p>
            </div>
        </>
    );
