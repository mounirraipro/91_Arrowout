...
export const metadata: Metadata = {
    title: 'Disclaimer',
    description: 'Read the Arrow Out disclaimer regarding website content accuracy, external links, and general use of our free online game.',
    keywords: ['Arrow Out disclaimer', 'website disclaimer', 'legal disclaimer'],
};
    ...
    return (
        <>
            ...
            <div className="page-content">
                <p>
                    The information provided by Arrow Out (&ldquo;we,&rdquo; &ldquo;us,&rdquo; or &ldquo;our&rdquo;) on arrowout.org
                ...
                <p>
                    Arrow Out is a browser-based entertainment product provided free of charge. The game
                ...
                <p>
                    Arrow Out displays third-party advertisements (including Google AdSense ads) to
                    ...
                    an endorsement or recommendation by Arrow Out.
                </p>
                ...
                <p>
                    ...
                    has been obtained from reliable sources, Arrow Out is not responsible for any errors
