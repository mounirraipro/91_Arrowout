...
export const metadata: Metadata = {
    ...
    description: 'Browse the complete sitemap of Arrow Out. Find every page on our website including games, blog posts, and information pages.',
    keywords: ['Arrow Out sitemap', 'all pages', 'site navigation'],
    alternates: {
...
const sections = [
    {
        ...
        links: [
            { href: '/', label: 'Home' },
            { href: '/play', label: 'Play Arrow Out' },
    ...
    },
    {
        ...
        links: [
            ...
            { href: '/blog/what-is-jigsolitaire', label: 'What is Arrow Out?' },
        ...
        <>
            <div className="page-header">
                <div className="container">
                    ...
                    <p>Browse every page on Arrow Out.</p>
                </div>
            </div>
