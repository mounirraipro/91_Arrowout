...
const SITE_URL = 'https://arrowout.org';
...
export function buildWebSiteSchema() {
    return {
        ...
        name: 'Arrow Out',
        url: SITE_URL,
        description: 'Play Arrow Out free online — no download, no account needed.',
        potentialAction: {
            '@type': 'SearchAction',
            target: {
                '@type': 'EntryPoint',
...
export function buildWebApplicationSchema() {
    return {
        ...
        description:
            'A free browser-based game. Play Arrow Out online instantly.',
        author: {
            '@type': 'Person',
            name: AUTHOR_NAME,
            url: AUTHOR_URL,
